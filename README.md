...
Startup Evaluation Report Writer for the Ideation Pipeline.
...
**Role:** Compiles all analysis into a comprehensive evaluation report

**Tools:** None (analysis only)

**Output:** Executive summary, full evaluation report, next steps
...
└───────────┬─────────────┘
            ...
            ▼
┌─────────────────────────┐
│  Report Generator Agent     │◄──── This repo
│  (GitHub Actions)       │
└───────────┬─────────────┘
            │
            ▼
...
curl -X POST \
  ...
  https://api.github.com/repos/Othentic-Ai/ideation-agent-report-generator/dispatches \
